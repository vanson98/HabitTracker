...
{
    public abstract class HabitTrackerWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HabitTrackerWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HabitTrackerWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<HabitTrackerDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<HabitTrackerDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HabitTrackerDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HabitTrackerDbContext, Task<T>> func)
        {
            T result;
