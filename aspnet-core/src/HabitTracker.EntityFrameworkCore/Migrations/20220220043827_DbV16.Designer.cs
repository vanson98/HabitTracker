...
namespace HabitTracker.Migrations
{
    ...
    [Migration("20220220043827_DbV16")]
    partial class DbV16
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitTracker.Habits.DailyLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HabitTracker.Habits.Habit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<float>("PracticeTime")
                        .HasColumnType("real");

                    b.Property<float>("TimeGoal")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("HabitTracker.Habits.HabitLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("HabitTracker.Investing.Investment", b =>
                {
                    ...
                    b.Property<int>("TotalAmountBuy")
                        .HasColumnType("int");

                    b.Property<int>("TotalAmountSell")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HabitTracker.Investing.InvestmentChannel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("HabitTracker.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("HabitTracker.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("HabitTracker.Habits.Habit", b =>
                {
                    b.HasOne("HabitTracker.Habits.HabitCategory", "HabitCategory")
                        .WithMany("Habits")
            ...
            modelBuilder.Entity("HabitTracker.Habits.HabitLog", b =>
                {
                    b.HasOne("HabitTracker.Habits.Habit", "Habit")
                        .WithMany("HabitLogs")
            ...
            modelBuilder.Entity("HabitTracker.Investing.Investment", b =>
                {
                    b.HasOne("HabitTracker.Investing.InvestmentChannel", "InvestmentChannel")
